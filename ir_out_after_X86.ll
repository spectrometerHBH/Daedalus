...
main_if_then_2:
    %t_20 = load %t_7 %i_2 8 8
    %t_21 = load %t_12 null 0 0
    %t_22 = move %t_20
    %t_22 = mul %t_22 %t_21
    store %t_22 %t_7 %t_17 1 0
    %tmp_3 = move %t_16
    %breaker_5 = move %tmp_3
    jump main_for_merge_2

main_if_else_1:
    %t_23 = load %t_12 null 0 0
    %t_24 = move %i_2
    %t_24 = mul %t_24 %t_23
    %t_25 = load %t_12 null 0 0
    %t_26 = move %t_25
    %t_26 = sub %t_26 1
    %t_27 = load %t_7 %i_2 8 8
    %t_28 = move %t_27
    %t_28 = mul %t_28 %t_26
