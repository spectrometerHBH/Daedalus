...
public class IRInterpreter_raw {
    ...
    public IRInterpreter_raw(InputStream in, boolean isSSAMode, DataInputStream data_in, PrintStream data_out) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IRInterpreter_raw vm = new IRInterpreter_raw(in, ssa, new DataInputStream(System.in), new PrintStream(System.out));
        //if (ssa)
